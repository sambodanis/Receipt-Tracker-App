//
//  PTPayerChooserViewController.m
//  PayTracker
//
...
@interface PTPayerChooserViewController ()


@end

@implementation PTPayerChooserViewController

@synthesize delegate;
@synthesize userArray = _userArray;

- (void)choiceMade:(int)selection
{
    [self.delegate userDidChoosePayer:[self.userArray objectAtIndex:selection]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [self choiceMade:(int)indexPath.row];
}
